...
$rm_send_address[] = 'moana7moana7@gmai.com';
...
//【任意】 自分に届くメールの題名
$rm_send_subject = '予約のお問い合わせがありました。';
...
$rm_send_name = 'EVER GRACE';




//【任意】 相手に届く自動返信メールの題名
$rm_thanks_subject = 'ご予約ありがとうございました。';
...
この度はフェイシャル３点セットのご予約をいただき、ありがとうございました。
担当者から後ほどご連絡させていただきますので、しばらくお待ちください。
以下の内容で仮予約をお受けいたしました。
...
エヴァーグレース プレミシャス 心斎橋店
〒542-0086 大阪府大阪市中央区西心斎橋１-4-5　御堂筋ビル7Ｆ
営業時間　火～土曜日 10：00～20：00／日・月・祝 10：00～18：00
HP : https://www.evergrace.jp
